...
const int ZKClient::FlagsType::PERSISTENT = ZOO_PERSISTENT;
...
bool ZKClient::init(const std::string &hosts, int recv_timeout, WatcherCallback cb, LogFuncPtr lcb)
{
    ...
    m_watcherCb = std::bind(cb, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, shared_from_this());
    m_logCb = lcb;
