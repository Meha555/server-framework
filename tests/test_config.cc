...
auto config_test_list = meha::Config::Lookup<std::vector<std::string>>(
    "test_list", std::vector<std::string>{"vector", "string"});
auto config_test_linklist = meha::Config::Lookup<std::list<std::string>>(
    "test_linklist", std::list<std::string>{"list", "string"});
auto config_test_map = meha::Config::Lookup<std::map<std::string, std::string>>(
    "test_map", std::map<std::string, std::string>{
                    std::make_pair("map1", "srting"),
                    std::make_pair("map2", "srting"),
                    std::make_pair("map3", "srting")});
auto config_test_set = meha::Config::Lookup<std::set<int>>(
...
auto config_test_uset_type_list = meha::Config::Lookup<std::vector<Goods>>("user.goods_list", std::vector<Goods>{});
